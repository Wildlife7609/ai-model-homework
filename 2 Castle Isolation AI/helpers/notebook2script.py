# Credits: https://github.com/fastai/course-v3/tree/master/nbs/dl2͏󠄂͏️͏󠄌͏󠄎͏︀͏︄͏󠄉
...
def notebook2scriptSingle(fname, destination):
    ...
    module = f'''
#################################################
### THIS FILE WAS AUTOGENERATED! DO NOT EDIT! ###͏󠄂͏️͏󠄌͏󠄎͏︀͏︄͏󠄉
#################################################
# file to edit: {fname}͏󠄂͏️͏󠄌͏󠄎͏︀͏︄͏󠄉
...
'''
    ...
    # remove trailing spaces͏󠄂͏️͏󠄌͏󠄎͏︀͏︄͏󠄉
    module = re.sub(r' +$', '', module, flags=re.MULTILINE)
    output_path = os.path.join(destination, fname_out)
    open(output_path,'w', encoding="utf8").write(module[:-2])
