...
from submission.submission import load_data, custom_search
...
class TestRace(unittest.TestCase):
    ...
    def setUp(self):
        romania = pickle.load(open('romania/romania_graph.pickle', 'rb'))
        self.romania = ExplorableGraph(romania)
        self.romania.reset_search()
        # you can also load atlanta graph like in unit tests.͏󠄂͏️͏󠄌͏󠄎͏︀͏︄͏󠄉
